  ...
  return (
    <>
      ...
      <div ref={containerRef}>
        ...
        {/* Counter Utility Component defined locally inside file for maximum compatibility */}
          ...
          <div className="container editorial-grid">
            ...
            <div className="grid-2 gsap-reveal" style={{ gap: '1.5rem' }}>
              {[
                ...
                <div key={idx} className="card premium-card hover-lift" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', justifyContent: 'center', borderInlineStart: '4px solid var(--color-primary)', background: 'var(--color-bg-light)' }}>
                  <h3 style={{ margin: 0, fontSize: '2.5rem', color: 'var(--color-bg-dark)', fontWeight: 800 }}>
                    <span className="counter-val" data-target={stat.end}>0</span>{stat.suffix || ''}
                  </h3>
                  <h4 style={{ margin: '0.4rem 0 0.2rem 0', fontSize: '1.05rem', color: 'var(--color-primary)' }}>{stat.label}</h4>
                  <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--color-text-muted)', lineHeight: 1.4 }}>{stat.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className="grid-2" style={{ gap: '2rem' }}>
              {[
                ...
                <div key={idx} className="card premium-card hover-lift gsap-reveal" style={{ padding: '2.5rem', background: 'var(--color-white)', display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
          ...
          <div className="container">
            ...
            <div className="grid-3" style={{ gap: '2rem' }}>
              {[
                ...
                <div key={idx} className="card premium-card hover-lift gsap-reveal" style={{ padding: 0, overflow: 'hidden', background: 'var(--color-steel-blue)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', height: '360px', display: 'flex', flexDirection: 'column' }}>
                  <div style={{ height: '180px', width: '100%', background: `url(${cov.img}) center/cover no-repeat` }}></div>
        ...
        {/* 4. BRANDS PREVIEW SECTION (INFINITE SCROLLING BRAND LOGOS CAROUSEL) */}
        <section className="section-padding" style={{ backgroundColor: 'var(--color-white)', overflow: 'hidden', borderBottom: '1px solid var(--color-light-gray)' }}>
          ...
          <div className="brand-marquee-container" style={{ position: 'relative', width: '100%', padding: '1.5rem 0', display: 'flex', overflow: 'hidden' }}>
            <div className="brand-marquee-scroll" style={{ display: 'flex', gap: '3rem', whiteSpace: 'nowrap', width: 'max-content' }}>
              {[
                { name: 'Maeda', type: 'Food', color: '#E4572E' },
                { name: 'Segafredo', type: 'Food', color: '#D90429' },
                { name: 'Cawell’s', type: 'Food', color: '#005F73' },
                { name: 'Julphar', type: 'Food', color: '#0A9396' },
                { name: 'Bigen', type: 'Non-Food', color: '#E9C46A' },
                { name: 'Titania', type: 'Non-Food', color: '#F4A261' },
                { name: 'Smart', type: 'Non-Food', color: '#2A9D8F' },
                { name: 'Kodak', type: 'Non-Food', color: '#E76F51' },
                { name: 'Peros', type: 'Non-Food', color: '#457B9D' },
                { name: 'Asperox', type: 'Non-Food', color: '#1D3557' },
                { name: 'Sparx', type: 'Non-Food', color: '#E63946' },
                ...
                <div key={idx} className="brand-logo-badge" style={{
                  ...
                  {/* Internal custom styles for hover grayscales */}
                  <style dangerouslySetInnerHTML={{ __html: `
                    .brand-logo-badge:hover {
                      border-color: ${brand.color}33;
                      background: #ffffff;
                      transform: translateY(-5px);
                      box-shadow: 0 10px 25px ${brand.color}15;
                    }
                    .brand-logo-badge:hover .brand-text {
                      color: ${brand.color} !important;
                      text-shadow: 0 0 10px ${brand.color}15;
                    }
                  `}} />
                </div>
              ))}
          ...
          <div className="container">
            ...
            <div className="grid-3" style={{ gap: '2rem' }}>
              {[
                ...
                <div key={idx} className="card premium-card hover-lift gsap-reveal" style={{ padding: '2.5rem', background: 'var(--color-white)', border: '1px solid var(--color-light-gray)', borderRadius: '8px', textAlign: 'initial' }}>
      ...
      {/* Scroll count activation script */}
